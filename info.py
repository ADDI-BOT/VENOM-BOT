...
if len(API_HASH) == 0:
    ...
    exit()
BOT_TOKEN = environ.get('BOT_TOKEN', '6599923780:AAFHHzgd2C93N_gOOFnLt_QTluXd1Jhr9B0')
if len(BOT_TOKEN) == 0:
...
INDEX_EXTENSIONS = [extensions.lower() for extensions in environ.get('INDEX_EXTENSIONS', 'mp4 mov wmv avi avchd flv f4v swf mkv webm html5').split()]
...
URL = environ.get("URL", "https://venon-mbot.onrender.com")
if len(URL) == 0:
